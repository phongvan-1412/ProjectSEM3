...
Begin
    ...
    Insert into Job(Title, [Location], Content, PostedDate, EndDate,SalaryMin, SalaryMax,[status],LevelId)
	OUTPUT  inserted.Id INTO @JobTmp
	values (@Title, @Location, @Content, @PostedDate, @EndDate,@SalaryMin, @SalaryMax,1,@LevelId)
